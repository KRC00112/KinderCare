		...
		<nav class="navbar navbar-expand-lg navbar-light" id="main-navbar">
			<div class="container">
				...
				<ul class="navbar-nav ml-auto" id="main-menu">
					...
					<li class="nav-item"><a class="nav-link" href="http://127.0.0.1/project/attendance/index.php ">Child Attendance</a></li> 
					<li class="nav-item"><a class="nav-link" href="http://127.0.0.1/AELG.php">Employee attendance</a></li>
					<li class="nav-item"><a class="nav-link" href="http://127.0.0.1/loginsystem1/welcome1.php">Logout</a></li>
