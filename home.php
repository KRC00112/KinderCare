		...
		<nav class="navbar navbar-expand-lg navbar-light" id="main-navbar">
			<div class="container">
				...
				<ul class="navbar-nav ml-auto" id="main-menu">
					...
					<li class="nav-item"><a class="nav-link" href="http://127.0.0.1/loginsystem/login.php">Guardian login</a></li> 
					<li class="nav-item"><a class="nav-link" href="http://127.0.0.1/loginsystem1/login1.php">Employee login</a></li>
					<li class="nav-item"><a class="nav-link" href="http://127.0.0.1/Registermain.html">Register</a></li>
