...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $existSql = "SELECT name,email,phone,aadhar,password,gender  
                FROM users 
    ...
    if ($numExistRows > 0) {
        ...
        if (($password == $cpassword)) {
            ...
            $sql = "INSERT INTO users (name, email, phone, aadhar, password, gender) 
                    VALUES ('$name', '$email', '$phone', '$aadhar', '$password', '$gender')";
